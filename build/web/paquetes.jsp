                ...
                <div class="templatemo-sidebar">
                    ...
                    <nav class="templatemo-left-nav">          
                        <ul>
                            ...
                            <li><a href="#" class="active"><img class="iconos-menu" src="iconos/paquetes.png">Paquetes</a></li>
                ...
                <div class="templatemo-content col-1 light-gray-bg">
                    ...
                    <div class="templatemo-content-container">
                        <div class="templatemo-content-widget white-bg">
                            <h2 class="margin-bottom-0">Paquetes<a href="paquete.jsp"><img class="agregar" src="iconos/agregar.png" alt="Agregar paquete" title="Agregar paquete"></a>
                                <a href="paquetes.jsp"><img class="buscar-lupa" src="iconos/lupa.png" alt="Buscar paquete" title="Buscar paquete"></a><div class="buscar-input"><input type="text" class="form-control" placeholder="Buscar" name="buscar_paquete" id="buscar_paquete"></div>
                            </h2>   
                        </div>

                        <%
                        List<PaqueteTuristico> listaPaquetes = control.getListaPaquetesHabilitados();
                        for (PaqueteTuristico paque : listaPaquetes) {
                        %>  
                        <div class="templatemo-flex-row flex-content-row">
                            <div class="col-1">              
                                <div class="panel panel-default margin-10">
                                    <div class="panel-heading"><h2><a href="ServletPaqueteTuristico?mostrar=ok&id=<%=paque.getCodigo_paquete()%>" class="link-blanco"><%=paque.getNombre()%></a><a href="ServletPaqueteTuristico?mostrar=ok&editar=ok&id=<%=paque.getCodigo_paquete()%>" class="buscar-lupa"><img src="iconos/lapiz-blanco.png"></a><a href="ServletPaqueteTuristico?eliminar=ok&id=<%=paque.getCodigo_paquete()%>" class="buscar-lupa"><img src="iconos/basura-blanco.png"></a></h2></div>
                                </div>
                            </div>
                        </div>
                        <%
